        ...
        >
          <div class="flex items-center justify-between gap-2">
            <div class="flex items-center gap-2 grow min-w-0">
              ...
              {:else}
                <div
                  class="flex items-center gap-2 group/col-title min-w-0 grow"
                >
                  <span
                  ...
                  {#if !isReadOnly}
                    <button
                      class="opacity-0 group-hover/col-title:opacity-30 hover:opacity-100! transition-all btn btn-ghost btn-xs btn-circle h-4.5 w-4.5 hover:bg-base-200 shrink-0"
                      onclick={() => {
            ...
            <div class="flex items-center gap-1.5 shrink-0">
              <span
                class="text-[9px] font-mono opacity-80 bg-secondary/10 text-secondary border border-secondary/20 px-1.5 py-0.5 rounded leading-none font-bold"
              >
                {col.definition}
              </span>
              {#if !isReadOnly}
